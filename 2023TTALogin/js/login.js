...
(function ($) {
    ...
    $(function () {
        ...
        //     if(checked) {
        //         $this.closest(termsForm).find(checkBox).prop('checked', true);
        //     } else {
        //         $this.closest(termsForm).find(checkBox).prop('checked', false);
        //     }
        // });
        // checkBox.on('click', function(){
        //     var $this = $(this),
        //         termsWrap = $this.closest(termsForm).find('.terms_wrap').not('.check_all_box');
        //     var termsWrap_cnt = termsWrap.length,
        //         checked_cnt = termsWrap.find('.check_box:checked').length;
        //
        //     if (checked_cnt < termsWrap_cnt) {
        //         allCheck.prop('checked', false);
        //     } else if (checked_cnt == termsWrap_cnt) {
