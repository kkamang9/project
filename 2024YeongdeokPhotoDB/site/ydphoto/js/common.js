...
(function ($) {
    ...
    $(function () {
        ...
        */
        ...
        // 푸터 바로가기 메뉴
        var $footerLink = $('.footer_wrap .footer_inner .footer_link'),
            $footerLinkBtn = $footerLink.find('.f_link_button .btn'),
            $footerLinkList = $footerLink.find('.f_link_list');
        $footerLinkBtn.on('click',function(){
            $footerLink.toggleClass('active');
            $footerLinkList.stop().slideToggle();
            if($footerLink.is('.active') === true){
                $footerLinkBtn.attr('title','바로가기 메뉴 닫기');
            } else if($footerLink.is('.active') === false){
                $footerLinkBtn.attr('title','바로가기 메뉴 열기');
            }
        });
